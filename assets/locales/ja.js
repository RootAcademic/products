...
I18n.addTranslations('ja', {
    ...
    aff: {
        ...
        matrixInsight: '<strong>重要ポイント：</strong>コミッション率はティアではなく、レベル（あなたからの距離）によって決まります。ティアは何レベルの深さまで報酬を得られるかを決めるだけです。例えば、ゴールドアフィリエイトはレベル1で15%、レベル2で7%、レベル3で5%を獲得します。',
        firstPurchaseNote: '直接紹介したユーザーの初回購入額の <strong data-live-first>80%</strong> がコミッションとしてあなたに還元されます。以下のレートは2回目以降の購入に適用されます。',

...
I18n.addTranslations('ko', {
    ...
    aff: {
        ...
        matrixInsight: '<strong>핵심 포인트:</strong> 수수료율은 등급이 아닌 레벨(당신으로부터의 거리)에 의해 결정됩니다. 등급은 몇 레벨 깊이까지 수익을 얻을 수 있는지를 결정할 뿐입니다. 예를 들어, 골드 제휴 파트너는 레벨 1에서 15%, 레벨 2에서 7%, 레벨 3에서 5%를 받습니다.',
        firstPurchaseNote: '직접 추천한 사용자의 첫 구매 금액의 <strong data-live-first>80%</strong>가 커미션으로 지급됩니다. 아래 요율은 이후 반복 구매에 적용됩니다.',
    ...
    mkt: {
        ...
        step1_2: '<a href="https://www.lovart.ai/" target="_blank" rel="noopener">lovart.ai</a>에 가입하고 사용하여, 다운로드한 포스터를 이 웹사이트에 업로드하세요. (무료로 사용할 수 있지만 12345VPN을 통한 연결이 필요합니다.)',
